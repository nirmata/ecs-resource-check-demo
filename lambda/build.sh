...
docker tag ecs-lambda-function-kyverno:{$1} 844333597536.dkr.ecr.us-west-1.amazonaws.com/nirmata/ecs-lambda-function-kyverno:{$1}
docker push 844333597536.dkr.ecr.us-west-1.amazonaws.com/nirmata/ecs-lambda-function-kyverno:{$1}
docker tag ecs-lambda-function-nctl:{$1} 844333597536.dkr.ecr.us-west-1.amazonaws.com/nirmata/ecs-lambda-function-nctl:{$1}
